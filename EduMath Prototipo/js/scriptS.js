...
function comenzar(){
    ...
    // Generar la suma - Números aleatorios entre 1 y 20
    num1 = Math.floor(Math.random() * 20) + 1;
    num2 = Math.floor(Math.random() * 20) + 1;
    respuesta = num1 + num2;

    // Asignar los números para que se muestren en la suma
...
btnIrTaller.addEventListener("click", function () {
...
btnMostrarRespuestas.addEventListener("click", function () {
    mostrarResultados();
});
